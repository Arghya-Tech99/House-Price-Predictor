...
class NumericalVsNumericalAnalysis(BivariateAnalysisStrategy):
    def analyze(self, df: pd.DataFrame, feature1: str, feature2: str):
        ...
        sea.scatterplot(x=feature1, y=feature2, data=df)
...
class CategoricalVsNumericalAnalysis(BivariateAnalysisStrategy):
    def analyze(self, df: pd.DataFrame, feature1: str, feature2: str):
        ...
        """
        plt.figure(figsize=(10, 6))
        sea.boxplot(x=feature1, y=feature2, data=df)
        plt.title(f"{feature1} vs {feature2}")
        plt.xlabel(feature1)
        plt.ylabel(feature2)
...
if __name__ == "__main__":
    ...
    # Load the data
    # df = pd.read_csv('C:/Users/Arghya/OneDrive/Documents/House-Price-Predict-PORTFOLIO/Load-data/Data/AmesHousing.csv')
    #
